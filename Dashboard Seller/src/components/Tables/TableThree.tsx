          ...
          >
            <div className="flex items-center gap-3 p-2.5 xl:p-5">
              {/* <div className="flex-shrink-0">
                <Image src={randomImage()} alt="User" width={48} height={48} />
              </div> */}
              <img src={product.images[0].Url} alt="product" width={48} height={48}/>
            ...
            <div className="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
              <p className="text-black dark:text-white"><Rating style={{color:"wheat",borderColor:"black"}} readonly={true} value={parseInt(product.rating)} /></p>
            </div>

            <div className="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
              <div className="flex items-center space-x-3.5">
               <Link href={{pathname:`http://localhost:3000/pages/updateproduct`,query:{product:JSON.stringify(product)}}}>
                 <button className="hover:text-primary" onClick={(e) => {
                   ...
                   Swal.fire({
                     ...
                     if (result.isConfirmed) {
                       window.location.href = `http://localhost:3000/pages/updateproduct?product=${JSON.stringify(product)}`;
                     }
                   });
                 }}>
                   <svg
